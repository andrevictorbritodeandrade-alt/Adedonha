...
const JOGOS_FALLBACK = [
  { id: 'adedonha', title: 'ADEDONHA INTERATIVA', subtitle: 'PROFESSOR E MÁGICO DE PALAVRAS', image_url: 'https://picsum.photos/seed/speicherstadt-urban/600/600', accent_color: '#107C10', path: 'adedonha', avatar_prompt: 'Professor negro, mestre das palavras, cercado por letras mágicas flutuantes (A, B, C, D), roleta de jogo ao fundo' },
  { id: 'perguntados', title: 'PERGUNTADOS', subtitle: 'GÊNIO DO CONHECIMENTO', image_url: 'https://picsum.photos/seed/wooden-pier-reeds/600/600', accent_color: '#0078D7', path: 'perguntados', avatar_prompt: 'Gênio negro, aura de sabedoria, segurando uma esfera de conhecimento brilhante, explosão vibrante de pontos de interrogação e exclamação coloridos em 3D' },
  { id: 'forca', title: 'JOGO DA FORCA', subtitle: 'INVESTIGADOR MISTERIOSO', image_url: 'https://picsum.photos/seed/silhouette-sunset/600/600', accent_color: '#D83B01', path: 'forca', avatar_prompt: 'Investigador negro, estilo detetive noir moderno, segurando uma lupa tecnológica, ícone limpo e estilizado de um boneco de forca simples' },
  { id: 'velha', title: 'JOGO DA VELHA', subtitle: 'DUELO ESTRATÉGICO X E O', image_url: 'https://picsum.photos/seed/old-wood-texture/600/600', accent_color: '#E81123', path: 'velha', avatar_prompt: 'Estrategista negro, mestre de jogos, segurando peças de X e O brilhantes, grade de jogo # ao fundo' },
  { id: 'memoria', title: 'JOGO DO MEMÓRIA', subtitle: 'MEMÓRIA DE ELEFANTE', image_url: 'https://picsum.photos/seed/silhouette-sunset/600/600', accent_color: '#68217A', path: 'memoria', avatar_prompt: 'Sábio negro, com duas cartas de memória viradas para cima mostrando um cérebro estilizado com uma exclamação' },
  { id: 'mapas', title: 'JOGO DOS MAPAS', subtitle: 'EXPLORADOR DE FRONTEIRAS', image_url: 'https://picsum.photos/seed/old-paper-world-map/600/600', accent_color: '#E3008C', path: 'mapas', avatar_prompt: 'Cartógrafo negro, aventureiro, segurando uma pilha de mapas nacionais sobrepostos (Brasil, EUA, Japão)' },
  { id: 'bandeiras', title: 'JOGO DAS BANDEIRAS', subtitle: 'EXPLORADOR DE CULTURAS', image_url: 'https://picsum.photos/seed/flag-collage/600/600', accent_color: '#00B294', path: 'bandeiras', avatar_prompt: 'Explorador negro, aventureiro moderno, segurando um globo terrestre brilhante, colagem vibrante e em cascata de bandeiras' },
  { id: 'ludo', title: 'LUDO', subtitle: 'MESTRE DO TABULEIRO', image_url: 'https://picsum.photos/seed/nyc-urban-landscape/600/600', accent_color: '#00CC6A', path: 'ludo', avatar_prompt: 'Mestre de tabuleiro negro, sorridente, com tabuleiro de ludo clássico em 3D e peões nas casas iniciais' },
  { id: 'uno', title: 'UNO', subtitle: 'ESTRATÉGIA DE CARTAS', image_url: 'https://picsum.photos/seed/sand-dunes/600/600', accent_color: '#5C2D91', path: 'uno', avatar_prompt: 'Estrategista de cartas negro, confiante, segurando cartas Uno coloridas (amarelo, azul, verde) com números e símbolo de compra 2' },
  { id: 'truco', title: 'TRUCO', subtitle: 'REI DO TRUCO', image_url: 'https://picsum.photos/seed/misty-mountains/600/600', accent_color: '#00188F', path: 'truco', avatar_prompt: 'Jogador de cartas negro, astuto e sorridente, segurando cartas de baralho clássicas (reis, damas, manilhas)' },
  { id: 'xadrez', title: 'XADREZ SORTUDO', subtitle: 'NSSTRE DE CHADREZ', image_url: 'https://picsum.photos/seed/canoe-lake/600/600', accent_color: '#A80000', path: 'xadrez', avatar_prompt: 'Personagem negro, mestre de xadrez, expressão focada e estratégica, tabuleiro de xadrez em 3D com peças (Rei, Rainha) dispostas' },
  { id: 'balaozinho', title: 'JOGO DO BALÃOZINHO', subtitle: 'VIAGEM NAS ALTURAS', image_url: 'https://picsum.photos/seed/chambord-castle/600/600', accent_color: '#008272', path: 'balaozinho', avatar_prompt: 'Aventureiro negro, sorridente, com óculos de aviador, um grande e colorido balão de ar quente com cesto de vime ao fundo' },
  { id: 'vermelhinho', title: 'ONDE ESTÁ O VERMELHINHO', subtitle: 'ONSTROS DE LONDBOA', image_url: 'https://picsum.photos/seed/london-street-architecture/600/600', accent_color: '#107C10', path: 'vermelhinho', avatar_prompt: 'Detetive negro, observador, com um ônibus vermelho de Londres de dois andares ao fundo' },
  { id: 'tatuzin', title: 'TATUZIN', subtitle: 'EXPLORADOR DE NATUREZA', image_url: 'https://picsum.photos/seed/mountain-landscape/600/600', accent_color: '#0078D7', path: 'tatuzin', avatar_prompt: 'Explorador negro da natureza, amigável, acompanhado de um tatu-bola mascote Fuleco (amarelo, azul e verde) acenando com uma pequena bandeira do Brasil' },
  { id: 'cruzaletras', title: 'CRUZALETRAS', subtitle: 'NOSTRA DE LEESAS', image_url: 'https://picsum.photos/seed/crossword-grid/600/600', accent_color: '#D83B01', path: 'cruzaletras', avatar_prompt: 'Estudioso negro, decifrador de enigmas, montando uma grade de palavras cruzadas preenchida com letras' },
];
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 md:gap-4 max-w-[1600px] mx-auto">
            ...
            <div className="relative overflow-hidden col-span-2 row-span-2 aspect-square md:aspect-auto rounded-sm shadow-lg border border-white/10 bg-[#1a1a1a] flex flex-col items-center justify-center p-6">
              <div className="bg-white p-4 rounded-xl shadow-inner mb-4">
                <QRCodeSVG value="https://whai.me/app.arena-de-jogos" size={160} />
              </div>
              <h2 className="font-display text-2xl text-white tracking-wide leading-tight drop-shadow-md">COMPARTILHAR</h2>
              <p className="text-gray-400 text-xs font-medium mt-1">whai.me/app.arena-de-jogos</p>
            </div>
          </div>
        </div>
