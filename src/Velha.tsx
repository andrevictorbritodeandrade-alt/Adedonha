  ...
  return (
    <div className="min-h-screen bg-magical font-sans p-4 text-white flex flex-col items-center">
      ...
      <header className="text-center mb-6 relative w-full max-w-4xl">
        <button 
          onClick={onBack}
          className="absolute left-0 top-1/2 -translate-y-1/2 bg-white text-rose-600 font-bold py-2 px-4 rounded-lg shadow hover:bg-rose-50 transition-colors border border-rose-200"
        >
          ⬅ Voltar
        </button>
